...
async def start_pm(client, message: Message):
    try:
        ...
        buttons = [
                [InlineKeyboardButton(text="〘 لتنصيب بوتك 〙", url=f"https://t.me/{OWNER[0]}")],
                [
                ...
                [
                    InlineKeyboardButton("𓏺 𝖺𝖣𝖣 𝖬𝖾 𝖳𝗈 𝖸𝗈𝗎𝗋 𝖦𝗋𝗈u𝗉𝗌 .", url=f"https://t.me/{bot.username}?startgroup=true"),
                ],
            ]
